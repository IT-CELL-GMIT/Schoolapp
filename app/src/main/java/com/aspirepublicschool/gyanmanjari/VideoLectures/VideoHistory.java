 ...
 * {@link VideoHistory.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link VideoHistory#newInstance} factory method to
...
public class VideoHistory extends Fragment {
     ...
     * @return A new instance of fragment VideoHistory.
     */
    // TODO: Rename and change types and number of parameters
    public static VideoHistory newInstance(String param1, String param2) {
        VideoHistory fragment = new VideoHistory();
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        homeWorkDetailsList.add(new VideoLectureModel(
                                ...
                                jsonObject.getString("des"),jsonObject.getString("status"),jsonObject.getString("status1"),jsonObject.getString("linkyt"),jsonObject.getString("id")

                        ));
                    }
                        // loadTeacherData(t_id);
                        VideoHistoryAdapter adapter = new VideoHistoryAdapter(ctx, homeWorkDetailsList);
